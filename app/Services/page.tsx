      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="grid auto-rows-min gap-4 md:grid-cols-3">
            <div className="relative aspect-video rounded-xl overflow-hidden mx-4 w-full">
              {/* Glowing gradient border background */}
              <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 blur-md opacity-75"></div>

              {/* Inner container for iframe with padding to show the border */}
              <div className="relative rounded-xl bg-muted/50 p-1">
                <iframe
          ...
          <p className="text-gray-800 text-xl font-semibold mt-10">
            {isArabic
              ? "تتولى الإدارة العامة لشؤون التنظيم المهام والمسؤوليات التالية :"
